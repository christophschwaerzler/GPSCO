...
Early on, it became obvious that the range of the trimmer in the OCXO kit was not sufficient to bring the frequency down
to the target frequency. The lowest I could get to was 10,000,002.4 Hz. A quick searcht on the WWW revealed that this is
...
R2 (resistor marking: 68B) with a 10k resistor, which braught the 10,000,000.0 right in the middle of the trimmer range.
